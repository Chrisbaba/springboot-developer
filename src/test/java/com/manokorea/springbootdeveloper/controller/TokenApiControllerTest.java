...
import com.manokorea.springbootdeveloper.config.jwt.JwtFactory;
import com.manokorea.springbootdeveloper.config.jwt.JwtProperties;
...
/**
 * 토큰을 생성하는 메서드인 createNewAccessToken() 메서드에 대한 테스트
 */
@SpringBootTest // Spring Boot 기반 테스트를 실행하는 테스트 클래스에 지정할 수 있는 주석
...
public class TokenApiControllerTest {
    ...
    public void createNewAccessToken() throws Exception {
        ...
        // When - 토큰 추가 API에 요청을 보냅니다. 이때, 요청 타입은 JSON이며, given절에서 미리 만들어둔 객체를
        // 요청 본문으로 함께 보냅니다.
