...
class BlogApiControllerTest {
    ...
    @Autowired
    protected ObjectMapper objectMapper; // 직렬화, 역직렬화를 위한 클래스 (자바 객체 <-> JSON 데이터)
    @Autowired
    ...
    void setSecurityContext() {
        ...
        // 인증 객체를 저장하는 시큐리티 컨텍스느에 setAuthentication() 메서드를 사용해 테스트 유저를 저장
